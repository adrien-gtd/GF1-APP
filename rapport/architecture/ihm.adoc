...
image::../images/UI/UI mobile - global.png[Diagramme utilisation interface utilisateur sur mobile,400,400]

===== Interface utilisateur sur PC

image::../images/UI/UI pc - global.png[Diagramme utilisation interface utilisateur sur PC,400,400]
...
image::../images/UI/UI pc - ecran recherche recettes.png[UI PC : écran d'accueil,400,400] 

====== Page d'accueil sur mobile

image::../images/UI/UI mobile - ecran accueil (recherche recettes).png[UI mobile : écran d'accueil,200,200]
...
image::../images/UI/UI pc - page recette (1 sur 2).png[UI PC: page recette 1/2,400,400] 
image::../images/UI/UI pc - page recette (2 sur 2).png[UI PC: page recette 2/2,400,400]

On passe d'un écran à l'autre par défilement.

===== Page d'accueil sur mobile

image::../images/UI/UI mobile - page recette (1.2 sur 2).png[UI mobile: page recette 1/2,200,200] 
image::../images/UI/UI mobile - page recette (2 sur 2).png[UI mobile: page recette 1/2,200,200]
...
image::../images/UI/UI mobile - ecran courses.png[UI mobile : écran courses,200,200]
...
NB: A terme, cette page devrait aussi exister sur PC, mais le design n'est pas encore fait

==== Page BILAN

===== Page de BILAN sur PC

image::../images/UI/UI pc - ecran Bilan.png[UI PC : écran BILAN,,400,400] 

===== Page de recette sur mobile

image::../images/UI/UI mobile - ecran bilan carbone.png[UI mobile : écran BILAN,200,200]
